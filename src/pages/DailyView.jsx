...
export default function DailyView() {
  ...
  return (
    <div className="min-h-screen bg-daily bg-no-repeat bg-cover bg-right bg-fixed text-white pt-20 px-4 tracking-wider">

      <div className="flex flex-row max-w-screen-lg mx-auto mb-7 p-5 text-center justify-center text-xl border-1 border-white/50 bg-gray-900/90 rounded">
      ...
      {hourlyData.map((hour) => (
        <div key={hour.time_epoch} className='max-w-screen-lg mx-auto my-2 p-2 border-1 border-white/50 bg-zinc-900/80 rounded'>
          ...
          <div className="flex flex-row m-1 py-3 text-center text-2xl justify-center border-1 border-white/50 bg-gray-900/90 rounded">
